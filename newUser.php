  ...
  <!-- Header div -->
        ...
        <div class="logo"><a href="index.php"><img src="images/Aalborg Zoo hvid.png" alt=""></a></div>
            ...
            <div class="main">
              <!-- overskrift-->
              <div class="box1">            
                    <h3>Indtast din kode til din nye profil</h3>
                    </div>
                <!-- valg div-->
                <div class="box2">
                    <div class="form">
...
/*
                    ...
                    $sql = "SELECT * FROM zoopwdReset WHERE pwdResetSelector = $selector";
*/
                    ...
                    if (empty($selector) || empty($validator) ) {
                        ...
                        if (ctype_xdigit($selector) !== false && ctype_xdigit($validator) !== false) {
                            ...
                            <form action="includes/reset-password.inc.php" method="POST">
                                ...
                                <button type="submit" name="resetpwdsubmit">Opret bruger</button>
                            </form>
                            <?php
                        }
                    }
